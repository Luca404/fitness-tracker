...
create table public.meal_items (
  ...
  category    text not null default 'other' check (category in ('grain','legume','vegetable','fruit','meat','fish','dairy','egg','plant_protein','fat','sauce','condiment','seasoning','sweet','alcohol','beverage','other')),
  food_key    text,
