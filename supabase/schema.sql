...
create table public.meal_items (
  ...
  category    text not null default 'other' check (category in ('grain','legume','vegetable','fruit','meat','fish','dairy','egg','fat','sauce','seasoning','sweet','alcohol','beverage','other')),
  food_key    text,
